...
2. UUIDs can be assumed to be unguessable and do not need to be validated. If a vulnerability requires guessing a UUID, it is not a valid vulnerability.
